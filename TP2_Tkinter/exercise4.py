...
# Block 00 separator
block00 = Frame(root)
block00.config(width ='800', height ='2', bg = '#323D4F')
block00.pack()
block00 = Frame(root)
block00.config(width ='800', height ='2', bg = '#FFF')
block00.pack()
block00 = Frame(root)
block00.config(width ='800', height ='2', bg = '#323D4F')
block00.pack()
...
# Add labels 
archive.add (file_1, text = "Label 1" ) 
archive.add (file_2, text = "Label 2")
archive.add (file_3, text = "Label 3")
archive.add (file_4, text = "Label 4")

# Content labels
file_1.config (bg = '#3A424F')
Label (file_1, text = "Content Label 1", font = "Calibri 25", fg = "white", bg = '#3A424F').place (x = 300, y = 200)
file_2.config (bg = '#72819C')
Label (file_2, text = "Content Label 2", font = "Calibri 25", fg = "white", bg = '#72819C').place (x = 300, y = 200)
file_3.config (bg = '#323D4F')
Label (file_3, text = "Content Label 3", font = "Calibri 25", fg = "white", bg = '#323D4F').place (x = 300, y = 200)
file_4.config (bg = '#2D4369')
Label (file_4, text = "Content Label 4", font = "Calibri 25", fg = "white", bg = '#2D4369').place (x = 300, y = 200)
